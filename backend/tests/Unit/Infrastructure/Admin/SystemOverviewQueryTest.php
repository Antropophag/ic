...
final class SystemOverviewQueryTest extends TestCase
{
    ...
    {
        $details = [
            'database' => ['databaseName' => 'ic'],
            'ldap' => ['endpoint' => 'ldap.example.test:389'],
            'smtp' => ['endpoint' => 'smtp.example.test:587'],
        ...
        $result = (new SystemOverviewQuery(
            ...
            $details,
            [
                'database' => static fn (): array => ['databaseVersion' => 'MariaDB 11.4'],
        ...
        self::assertSame('MariaDB 11.4', $result['services']['database']['details']['databaseVersion']);
