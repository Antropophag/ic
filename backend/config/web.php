    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'POST api/v1/requests/<id:\\d+>/ai/technical-specification/analyze' => 'ai-request/analyze',
                'POST api/v1/requests/<id:\\d+>/ai/technical-specification/draft' => 'ai-request/draft',
