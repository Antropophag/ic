...
slices. Цветовая метка, смена подразделения, назначение исполнителя,
запуск/приостановка/возобновление, отказ и отзыв уже следуют схеме: controller переводит HTTP-ввод в command,
